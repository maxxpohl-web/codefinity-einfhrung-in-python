...
product_Perishable = "Perishable" in product_type # prüfen ob das Produk verderblich ist 
# print(product_Perishable) 

if product_type == "Perishable":
    if days_until_expiration == 3 or days_until_expiration <= 3 and stock_level > 50:
